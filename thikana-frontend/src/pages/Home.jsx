...
const Home = () => {
  ...
  // Fetch user favorites if logged in, to set favorited status on cards
  ...
  const favoritedIds = new Set(favoritesList.map(fav => fav.property_id));
  ...
  const meta = propertiesData?.meta || { page: 1, totalPages: 1, total: 0 };
    ...
    <div className="space-y-12">
      ...
      <section className="relative rounded-3xl overflow-hidden py-20 px-6 sm:px-12 md:px-20 text-center bg-gradient-to-tr from-emerald-800 to-sky-950 text-white shadow-xl">
        ...
        <div className="relative max-w-3xl mx-auto space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight font-display leading-tight">
            Find Your Perfect <span className="text-emerald-400">Thikana</span> in Bangladesh
          </h1>
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 pb-4">
          <div>
            <h2 className="text-2xl font-bold font-display text-slate-800">Available Properties</h2>
        ...
        {propertiesLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="animate-pulse bg-white border border-slate-100 rounded-2xl overflow-hidden h-[380px]">
          ...
          <div className="bg-red-50 border border-red-200 text-red-700 p-6 rounded-2xl flex items-center gap-3 max-w-xl mx-auto">
            ...
            <div>
              ...
              <p className="text-sm text-red-600">Please verify your server connection and try again.</p>
            </div>
          </div>
        ) : properties.length === 0 ? (
          /* Empty State */
          <div className="text-center py-16 bg-white border border-slate-150 rounded-2xl max-w-md mx-auto p-8 shadow-sm">
            ...
            <p className="text-sm text-slate-500 mb-6">We couldn't find any listings matching your criteria. Try adjusting your search filters.</p>
            <button
              onClick={handleReset}
